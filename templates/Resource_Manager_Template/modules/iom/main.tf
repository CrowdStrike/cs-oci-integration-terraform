...
resource "oci_identity_policy" "fcs_inventory_policy_without_domains" {
  ...
  statements = [
    ...
    "Allow group ${var.group_name} to read certificates in tenancy",
    "Allow group ${var.group_name} to read budgets-family in tenancy",
...
resource "oci_identity_policy" "fcs_inventory_policy_with_domains" {
  ...
  statements = [
    ...
    "Allow group 'Default'/'${var.group_name}' to read certificates in tenancy",
    "Allow group 'Default'/'${var.group_name}' to read budgets-family in tenancy",
